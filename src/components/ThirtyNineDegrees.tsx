...
입안에 단어를 채워둘게"
      ...
      <AboutWiki
        ...
        sub="해남"
        description="이 글은 공동 작성자 Liam Oceanhart 리암 오션하트는 해남이자 슈퍼히어로입니다. 그는 생계를 위한 물질 중 불현듯 자신의 잠재된 슈퍼파워를 발견하여 슈퍼히어로의 길을 걸었습니다. 그는 10년간의 물질 경력을 통해 물 속에서 10시간을 버틸 수 있는 힘을 발현시켰습니다. 이 슈퍼파워를 활용하여, 일반인의 1000배에 달하는 각종 어패류의 수확량을 통해 제주도의 경제를 책임집니다. 그는 강인한 의지로 무장하여, 희망과 영감을 전파하며 우리가 내면에 품고 있는 잠재력을 상기시킵니다."
        category="레저 스포츠"
      />
      <Spacing height={24} />
      <Container>
