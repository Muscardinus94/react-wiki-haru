...
커피는 차갑게"
      ...
      <AboutWiki
        ...
        artist="Jose A. Bock"
        sub="푸드파이터"
        description='이 글은 공동 작성자 Jose A. Bock 호세 에이 복은 세계 각국의 브런치 레스토랑에서 열리는 핫도그 푸드파이팅 대회에 참가하는 전문가입니다. 태평양의 작은 고릴라 섬에서 태어나 자란 그는 "핫도그 고릴라"라는 별명으로 불리며, 먹을 것에 대한 열정으로 세계적으로 유명한 푸드파이터입니다. 현재 그는 핫도그 토너먼트에서 가장 유명한 인물로 알려져 있습니다.'
        category="조리"
      />
      <Spacing height={24} />
      <Container>
