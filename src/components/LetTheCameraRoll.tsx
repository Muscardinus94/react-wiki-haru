...
Action!"
      ...
      <AboutWiki
        ...
        description="이 글은 공동 작성자 Dongho Lee 이동호는 영화 평론가로 영화에 대한 신랄한 평가를 제시합니다. 그의 글은 독자들에게 도전적인 생각을 전달하며 논란을 자아냅니다. 이외로 그는 영화 뿐 아니라 예민한 주제인 사람의 인성과 종교 등을 다루는 악취미를 가지고 있습니다. 그러나 이러한 악취미 또한 모순이 없는 완벽한 평론으로 상당한 지지를 받고 있습니다. 그는 주제를 선입견 없이 다루며 철저한 사실 확인과 근거를 통해 평가합니다. 그의 악취미는 오히려 그의 평론을 독특하고 깊이 있는 분석으로 이끌어냅니다. 이에 그는 영화 평론가로서뿐만 아니라, 그의 악취미에 대해서도 상당한 지지를 받고 있습니다."
        sub="영화  평론가"
        category="영화"
      />
      <Spacing height={24} />
